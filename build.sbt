...
lazy val publishSettings = Seq(
  ...
  homepage := Some(url("https://github.com/wix-incubator/ocicat")),
  scmInfo := Some(ScmInfo(url("https://github.com/wix-incubator/ocicat"), "git@github.com:wix-incubator/ocicat.git")),
  publishTo := Some(
    if (isSnapshot.value)
  ...
  licenses += ("MIT", url("https://github.com/wix-incubator/ocicat/blob/master/LICENSE.md")),
...
lazy val root = (project in file("."))
  .settings()
  .aggregate(ocicat_core)

lazy val ocicat_core = (project in file("ocicat-core")).settings(
  name := "ocicat",
  commonSettings,
  publishSettings
)
